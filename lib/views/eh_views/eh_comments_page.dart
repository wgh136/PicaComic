    ...
    Widget body = StateBuilder<CommentsPageLogic>(
      ...
      builder: (logic) {
        if (logic.isLoading) {
          ...
          return showNetworkError(logic.message!, () => logic.change(), context,
              showBack: false);
        } else {
          return Column(
            children: [
...
class _EhComment extends StatelessWidget {
  ...
  Widget _buildLine(String htmlText) {
    ...
    void parse(dom.Node node, TextStyle style, [TapGestureRecognizer? recognizer]) {
