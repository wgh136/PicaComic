...
class SearchPage extends StatefulWidget {
  const SearchPage({required this.controller, this.onPop, this.onSearch, this.type, super.key});
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(bottom: BorderSide(color: Theme.of(context).colorScheme.outline, width: 0.8))
            ),
            child: Row(
              children: [
