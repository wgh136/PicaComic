        ...
        children: [
          Column(
            ...
            children: [
              const Padding(
                ...
                child: Text("使用前须知", style: TextStyle(fontSize: 30),),
              ),
           ...
           Column(
            ...
            children: [
              const Padding(
                padding: EdgeInsets.fromLTRB(16, 16, 0, 0),
                child: Text("开始设置", style: TextStyle(fontSize: 30),),
              ),
              Expanded(child: Center(child: Padding(
                padding: const EdgeInsets.only(bottom: 60, left: 16, right: 16),
                child: Text(
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Text("漫画列表显示方式".tr, style: const TextStyle(fontSize: 30),),
              ),
              Expanded(child: Center(child: Padding(
                padding: const EdgeInsets.only(bottom: 60, left: 16, right: 16),
                child: Card(
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 16, 0, 0),
                child: Text("阅读设置".tr, style: const TextStyle(fontSize: 30),),
              ),
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 16, 0, 0),
                child: Text("App外观".tr, style: const TextStyle(fontSize: 30),),
              ),
              Expanded(child: Center(child: Padding(
                padding: const EdgeInsets.only(bottom: 60, left: 16, right: 16),
                child: Card(
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 16, 0, 0),
                child: Text("更多".tr, style: const TextStyle(fontSize: 30),),
              ),
              Expanded(child: Center(child: Padding(
                padding: const EdgeInsets.only(bottom: 60, left: 16, right: 16),
                child: Card(
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 16, 0, 0),
                child: Text("登录".tr, style: const TextStyle(fontSize: 30),),
              ),
              Expanded(child: Center(child: Padding(
                padding: const EdgeInsets.only(bottom: 60, left: 16, right: 16),
                child: Card(
