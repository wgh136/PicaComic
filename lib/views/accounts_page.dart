            ...
            slivers: [
              ...
              SliverList(delegate: SliverChildListDelegate([
                const Padding(
                  ...
                  child: Text("Picacg", style: TextStyle(fontSize: 20),),
                ),
                if(appdata.token != "")
                ListTile(
                  title: Text("头像".tr),
                ...
                ListTile(
                  ...
                  onTap: () => Clipboard.setData(ClipboardData(text: appdata.user.email)),
                ),
                if(appdata.token != "")
                ListTile(
                  title: Text("用户名".tr),
                  subtitle: Text(appdata.user.name),
                  onTap: () => Clipboard.setData(ClipboardData(text: appdata.user.name)),
                ),
                if(appdata.token != "")
                ListTile(
                  title: Text("等级".tr),
                ...
                const Padding(
                  padding: EdgeInsets.fromLTRB(16, 8, 16, 8),
                  child: Text("Ehentai", style: TextStyle(fontSize: 20),),
                ),
                if(appdata.ehAccount == "")
                  ListTile(
                    title: const Text("登录"),
                    onTap: () => Get.to(() => const EhLoginPage())?.then((v) => logic.update()),
                  ),
                if(appdata.ehAccount != "")
                  ListTile(
                    title: Text("用户名".tr),
                    subtitle: Text(appdata.ehAccount),
                    onTap: () => Clipboard.setData(ClipboardData(text: appdata.ehAccount)),
                  ),
                if(appdata.ehAccount != "")
                  ListTile(
                    title: const Text("ipb_member_id"),
                    subtitle: Text(appdata.ehId),
                    onTap: () => Clipboard.setData(ClipboardData(text: appdata.ehId)),
                  ),
                if(appdata.ehAccount != "")
                  ListTile(
                    title: const Text("ipb_pass_hash"),
                    subtitle: Text(appdata.ehPassHash),
                    onTap: () => Clipboard.setData(ClipboardData(text: appdata.ehPassHash)),
                  ),
                if(appdata.ehAccount != "")
                  ListTile(
                    title: const Text("igneous"),
                    subtitle: Text(appdata.igneous),
                    onTap: () => Clipboard.setData(ClipboardData(text: appdata.igneous)),
                  ),
                if(appdata.ehAccount != "")
                  ListTile(
                    title: Text("退出登录".tr),
                ...
                Padding(
                  ...
                  child: Text("禁漫天堂".tr, style: const TextStyle(fontSize: 20),),
                ),
                if(appdata.jmEmail != "")
                  ListTile(
                    title: Text("用户名".tr),
                    subtitle: Text(appdata.jmName),
                    onTap: () => Clipboard.setData(ClipboardData(text: appdata.jmName)),
                  ),
                if(appdata.jmEmail != "")
                  ListTile(
                    title: const Text("Email"),
                    subtitle: Text(appdata.jmEmail),
                    onTap: () => Clipboard.setData(ClipboardData(text: appdata.jmEmail)),
                  ),
                if(appdata.jmEmail == "")
                  ListTile(
                    title: Text("登录".tr),
                    onTap: () => Get.to(() => const JmLoginPage())?.then((v) => logic.update()),
                  ),
                if(appdata.jmEmail != "")
                  ListTile(
                    title: Text("重新登录".tr),
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(16, 8, 16, 8),
                  child: Text("绅士漫画".tr, style: const TextStyle(fontSize: 20),),
                ),
                if(appdata.htName != "")
                ListTile(
                  title: Text("用户名".tr),
                  subtitle: Text(appdata.htName),
                  onTap: () => Clipboard.setData(ClipboardData(text: appdata.htName)),
                ),
                if(appdata.htName != "")
                  ListTile(
                    title: Text("退出登录".tr),
                ...
                if(appdata.htName == "")
                  ListTile(
                    title: Text("登录".tr),
                    onTap: () => Get.to(() => const HtLoginPage())?.then((v) => logic.update()),
                  )
              ])),
