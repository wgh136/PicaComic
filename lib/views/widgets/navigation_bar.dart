...
class _NaviPaneState extends State<NaviPane> with SingleTickerProviderStateMixin{
  ...
  Widget buildLeft() {
    ...
    return Material(
      child: Container(
        width: _kFoldedSideBarWidth + (_kSideBarWidth - _kFoldedSideBarWidth) * ((value - 2).clamp(0, 1)),
        height: double.infinity,
        padding: const EdgeInsets.symmetric(horizontal: 8),
        child: Row(
          children: [
            SizedBox(
              width: value == 3 ? (_kSideBarWidth - 16) : (_kFoldedSideBarWidth - 16),
              child: Column(
                children: [
...
class _SingleBottomNaviWidget extends StatefulWidget {
  ...
  @override
  State<_SingleBottomNaviWidget> createState() => _SingleBottomNaviWidgetState();
}

class _SingleBottomNaviWidgetState extends State<_SingleBottomNaviWidget> with SingleTickerProviderStateMixin{
  late AnimationController controller;
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: value != 0
                            ...
                            : (isHovering ? colorScheme.surfaceContainerHighest : null)),
